...
public void newGame(){							// метод newGame
}
...
public void keyPressed(int Code){ // метод принимающий код нажатой клавиши
	  if (Code==16777220 && direction==2){  // если нажата клавиша вправо и движение змейки происходит по оси Y 
		  directionValue.x=20;           // смещение координаты x =20  
		  direction=1; 					 // движение происходит по оси X	
	  }
	  if (Code==16777219 && direction==2) { // если нажата клавиша влево и движение змейки происходит по оси Y 
	      directionValue.x=-20;				// смещение координаты x =-20  
		  direction=1; 						// движение происходит по оси X
	  }
	  if (Code==16777218 && direction==1) { // если нажата клавиша вниз и движение змейки происходит по оси Х 
		  directionValue.y=20;				// смещение координаты y =20  
		  direction=2;  					// движение происходит по оси Y
  	  }
	  if (Code==16777217 && direction==1)  {// если нажата клавиша вверх и движение змейки происходит по оси Х 
		  directionValue.y=-20;				// смещение координаты y = -20  
		  direction=2; 						// движение происходит по оси Y
	  }
}  
